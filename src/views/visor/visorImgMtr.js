...
class DetalleClinico {
    ...
    fetch() {
        ...
        m.request({
                method: "GET",
                url: "https://api.hospitalmetropolitano.org/v2/pacientes/resultado/mtr/i/?id=" + VisorImgMTR.id,
                headers: {
                    "Authorization": localStorage.accessToken,
                },
            })
