...
class DetalleClinico {
    ...
    fetch() {
        ...
        m.request({
                method: "POST",
                url: "https://api.hospitalmetropolitano.org/t/v1/generate-qr-pte",
                body: {
                    numAt: VisorQR.numAtencion
                }
...
class VisorQR extends App {
    static numAtencion = null;
    constructor() {
        super();
    }
    oninit(_data) {

        if (_data.attrs.numAtencion !== undefined) {
            VisorQR.numAtencion = _data.attrs.numAtencion;
        }

        this._setTitle = "Código QR";
